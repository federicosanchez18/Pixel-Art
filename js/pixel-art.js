...
var bottonBorrar = document.getElementById("borrar")
...
//evento para pintar presionado
grilla.addEventListener('mousemove',pintarPresionado);

//capturamos el evento cuando apretamos el boton
bottonBorrar.addEventListener('click', borrarColoresGrilla);
...
//Implementacion para poder cargar los heroes 
